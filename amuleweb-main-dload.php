...
<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css" integrity="sha384-7tY7Dc2Q8WQTKGz2Fa0vC4dWQo07N4mJjKvHfIGnxuC4vPqFGFQppd9b3NWpf18/" crossorigin="anonymous">
	...
	<style type="text/css">
		...
		/* Keep the filter toolbar items vertically centered on one line */
		.form-tasks .btn,
		.form-tasks .btn-group,
		.form-tasks select {
			vertical-align: middle;
		}
		.btn-filter {
	...
	function dloadPoll() {
		// Don't disrupt a selection in progress (batch pause/cancel/etc.)
	...
	// Make the filter selects exactly as tall as the toolbar buttons,
	// so the whole filter row lines up uniformly.
	function matchFilterHeights() {
		var btn = document.querySelector('.form-tasks .btn');
		if (!btn) return;
		var h = btn.offsetHeight;
		if (!h) return;
		['filter', 'category'].forEach(function(id) {
	...
	document.addEventListener('DOMContentLoaded', function() {
		matchFilterHeights();
		window.addEventListener('resize', matchFilterHeights);
...
<body class="animated fadeIn" style="animation-duration: 1.5s">
	...
	<nav class="navbar  navbar-fixed-top" role="navigation">
	    <div class="container">
	    	<a class="navbar-brand" href="#"><img src="logo-nav.png" class="logo-nav">aMule WebUI <small style="font-weight:normal;font-size:12px;opacity:0.9;">powered by micromante <span style="color:#e74c3c;">&#10084;</span></small></a>
  		...
  		<div class="panel-body container panel-center">
    		...
    		<a class="btn btn-filter" href="javascript:formCommandSubmit('filter');" title="Filter">
					<span class="glyphicon glyphicon-filter"></span>
						<div style="font-size:13px"><br>Filter</div>
					</a>
    		<?php
    			if ($_SESSION["guest_login"] != 0) {
	...
	<div id="footer">
		...
		<div class="col-md-5">
			<form name="formlink" method="get" class="form-inline" action="amuleweb-main-dload.php" role="form" id="formed2link">
    			<div class="btn-group">
