...
<body class="animated fadeIn" style="animation-duration: 1.5s">
    ...
    <div class="panel panel-tasks">
  		<div class="panel-body container panel-center">
    		<div class="form-inline form-tasks" action="amuleweb-main-shared.php" method="get" name="mainform">
    		...
    		<div class="btn-group">
    			...
    			<a class="btn" href="javascript:formCommandSubmit('reload');" title="Refresh">
						...
						<div style="font-size:13px"><br>Refresh</div>
					</a>
	...
	<div class="container-fluid panel-tr">
		...
		<div id="footer">
			...
			<div class="col-md-5">
				<form name="formlink" method="get" class="form-inline" action="amuleweb-main-shared.php" role="form" id="formed2link">
	    			<div class="btn-group">
